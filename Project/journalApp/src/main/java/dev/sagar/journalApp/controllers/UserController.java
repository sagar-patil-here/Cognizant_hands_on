...
import dev.sagar.journalApp.Services.WeatherService;
...
//        Dbuser.setPassword(passwordEncoder.encode(user.getPassword()));
    ...
    public ResponseEntity<?> getGreeting() {
        ...
        int temp = we.getWeather("Mumbai").getCurrent().getTemperature();
        return new ResponseEntity<>("Hi " + name + "!, The weather temprature in mumbai is :" + temp + " degC", HttpStatus.OK);
    }
